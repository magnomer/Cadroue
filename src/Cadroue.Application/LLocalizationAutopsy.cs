...
public sealed class LLocalizationAutopsy
{
    ...
    public static bool LLocalizationAutopsyRead(string lLocalizationAutopsyKey, out string lLocalizationAutopsyValue)
    {
    ...
    private static LLocalizationAutopsy? LLocalizationAutopsyLoad(string lLocalizationAutopsyCode)
    {
        try
        {
            if (LLocalization.LLocalizationResourceRead(
                    LLocalizationAutopsyPrefix + lLocalizationAutopsyCode + LLocalizationAutopsySuffix)
                is not { } lLocalizationAutopsyJson)
            {
                return null;
            }

            return LLocalizationAutopsyParse(lLocalizationAutopsyJson);
        }
        catch (Exception lLocalizationAutopsyException)
        {
            LLocalization.LLocalizationTraceRecord(
