...
public partial class PToolbar
{
    ...
    private static void PChromeButtonApply(Button pChromeButton, bool pChromeClose, CornerRadius pChromeCornerRadius)
    {
        ...
        pChromeButton.Style = PHouse.PButton.PButtonChromeCreate(pChromeClose, pChromeCornerRadius);
    }
    ...
    protected override void OnPreviewMouseMove(MouseEventArgs e)
    {
        ...
        {
            PHouse.PSash.PSashDragMove(pWindow, e, PChromeButtonHeight);
        }
        pChromePressArmed = false;
        pChromeDragActive = false;
    }
    ...
    {
        if (PHouse.PSash.PSashInteractiveCheck(pChromeSource))
        {
            return false;
        }
