...
public partial class PRail : UserControl
{
    ...
    private void PTabMenuHandle(object sender, RoutedEventArgs e)
    {
        ...
        PTabMenuAppend(pTabAddMenu, "Split", "Tab.Split", PIcon.PIconRead("/PAsset/PTab/PSplitButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Edit", "Tab.Edit", PIcon.PIconRead("/PAsset/PTab/PEditButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Fix", "Tab.Fix", PIcon.PIconRead("/PAsset/PTab/PFixButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Audio", "Tab.Audio", PIcon.PIconRead("/PAsset/PTab/PAudioButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Convert", "Tab.Convert", PIcon.PIconRead("/PAsset/PTab/PConvertButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Merge", "Tab.Merge", PIcon.PIconRead("/PAsset/PTab/PMergeButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Funnel", "Tab.Funnel", PIcon.PIconRead("/PAsset/PTab/PFunnelButton.svg"));
        PTabMenuAppend(pTabAddMenu, "Worklist", "Tab.Worklist", PIcon.PIconRead("/PAsset/PTab/PWorklistButton.svg"));
