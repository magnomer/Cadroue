...
internal sealed partial class PSEncoder
{
    ...
    private static readonly Brush PSEncoderChipFill = PSEncoderChipBrushCreate(0xEC, 0xF1, 0xFD);
    private static readonly Brush PSEncoderChipText = PSEncoderChipBrushCreate(0x2F, 0x62, 0xD6);
    ...
    private static Brush PSEncoderChipBrushCreate(byte pRed, byte pGreen, byte pBlue)
    {
    ...
    private static DataTemplate PSEncoderChipBuild()
    {
        ...
        pHead.SetBinding(TextBlock.TextProperty, PSEncoderChipBind("head"));
        ...
        pToken.SetBinding(TextBlock.TextProperty, PSEncoderChipBind("token"));
        ...
        pChip.SetBinding(UIElement.VisibilityProperty, PSEncoderChipBind("chip"));
    ...
    private static Binding PSEncoderChipBind(string pPart) =>
