...
public sealed class TEncodeConvert
{
    [Fact]
    public void Convert_AppliesRequestedCodecAndContainerDestination()
    {
        ...
        LEncoding encoding = TEncodeCommand.TOutputCreate(
        ...
        Assert.Equal("libx265", TEncodeToken.TEncodeOptionRead(tokens, "-c:v"));
        Assert.Equal("24", TEncodeToken.TEncodeOptionRead(tokens, "-crf"));
        Assert.Equal("medium", TEncodeToken.TEncodeOptionRead(tokens, "-preset"));
        Assert.Equal("flac", TEncodeToken.TEncodeOptionRead(tokens, "-c:a"));
    ...
    public void HevcAutoPixel_UsesDeliveryCompatible420Layout()
    {
        ...
        TEncodeCommand.TSourcePixelApply(work, "yuv422p10le");

        IReadOnlyList<string> tokens = TEncodeToken.TEncodeTokenRead(
            Assert.Single(TEncodeCommand.TEncodeStagesBuild(work)).LEncodeStageArguments);

        Assert.Equal("yuv420p10le", TEncodeToken.TEncodeOptionRead(tokens, "-pix_fmt"));
    }
    ...
    public void HevcExplicitPixel_PreservesRequestedProfessionalLayout()
    {
        ...
        Assert.Equal("yuv422p10le", TEncodeToken.TEncodeOptionRead(tokens, "-pix_fmt"));
    }
    ...
    public void HevcQsvAutoPixel_UsesSupported420Layout()
    {
        ...
        Assert.Equal("p010le", TEncodeToken.TEncodeOptionRead(tokens, "-pix_fmt"));
    }
    ...
    public void AutoPixel_CoversEveryCatalogEncoder(string encoder, string? expectedPixel)
    {
        ...
        TEncodeCommand.TSourcePixelApply(work, "yuv420p");
        ...
        {
            Assert.Equal(expectedPixel, TEncodeToken.TEncodeOptionRead(tokens, "-pix_fmt"));
        }
    }
    ...
    public void AutoPixel_TableCoversEveryCatalogEncoder()
    {
        ...
        Assert.Equal(expected, TEncodeCommand.TVideoEncodersRead());
    }
    ...
    public void AutoPixel_PreservesReceivedAlphaForCapableEncoder(string encoder, string expectedPixel)
    {
        ...
        TEncodeCommand.TSourcePixelApply(work, "yuva444p10le");
    ...
    public void ApvAutoPixel_PreservesReceivedTwelveBitDepth(string sourcePixel, string expectedPixel)
    {
        ...
        TEncodeCommand.TSourcePixelApply(work, sourcePixel);
