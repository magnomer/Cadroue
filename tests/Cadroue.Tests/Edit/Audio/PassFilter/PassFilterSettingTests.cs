...
public sealed class PassFilterSettingTests
{
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkHighCreate(true, 80, 12, 3, 5);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkLowCreate(true, 9000, 0, 0, 0);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkHighCreate(true, 80, 0, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkHighCreate(true, 80, 2, 2, 0);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkLowCreate(true, 9000, 20, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkLowCreate(true, 9000, 2, 2, 5);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkHighCreate(true, 5, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkHighCreate(true, 9999, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkLowCreate(true, 100, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.WorkLowCreate(true, 99999, 2, 2, 0.707);
