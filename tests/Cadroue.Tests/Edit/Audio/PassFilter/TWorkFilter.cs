...
public sealed class TWorkFilter
{
    [Fact]
    public void HighPassSettings_AboveMaximum_AreClamped()
    {
        var step = (LWorkPassStep)TInterface.TWorkHighCreate(true, 80, 12, 3, 5);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkLowCreate(true, 9000, 0, 0, 0);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkHighCreate(true, 80, 0, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkHighCreate(true, 80, 2, 2, 0);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkLowCreate(true, 9000, 20, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkLowCreate(true, 9000, 2, 2, 5);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkHighCreate(true, 5, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkHighCreate(true, 9999, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkLowCreate(true, 100, 2, 2, 0.707);
    ...
    {
        var step = (LWorkPassStep)TInterface.TWorkLowCreate(true, 99999, 2, 2, 0.707);
