...
public sealed class NeutralWheelTests
{
    [Fact]
    public void ColorResolve_Centre_YieldsNeutralUnityGains()
    {
        LNeutralSample sample = TNeutral.ColorResolve(0, 0);
    ...
    public void WheelResolve_InvertsColorResolve(double x, double y)
    {
        ...
        LNeutralSample sample = TNeutral.ColorResolve(x, y);
        LNeutralWheel wheel = TNeutral.WheelResolve(
    ...
    public void ColorResolve_ClampsToDiscEdge()
    {
        ...
        LNeutralSample sample = TNeutral.ColorResolve(3, 4);
    ...
    {
        LNeutralWheel wheel = TNeutral.WheelResolve(128, 128, 128);
    ...
    {
        LNeutralWheel wheel = TNeutral.WheelResolve(0, 0, 0);
    ...
    {
        byte[] pixels = FrameFill(4, 6, 180, 160, 130, 255);

        LNeutralWheel wheel = TNeutral.AnalyzeResolve(
            pixels, 4, 6, LWhitebalanceMethod.LWhitebalanceMethodAverage);
        LNeutralWheel direct = TNeutral.WheelResolve(180, 160, 130);
    ...
    public void AnalyzeResolve_TransparentPixels_AreIgnored()
    {
        ...
        LNeutralWheel direct = TNeutral.WheelResolve(200, 150, 120);
    ...
    private static byte[] FrameFill(int width, int height, byte r, byte g, byte b, byte a)
    {
