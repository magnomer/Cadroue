...
public sealed class TNeutralDisplay
{
    [Fact]
    public void Display_ManualWithSample_ShowsClampedSampledRgb()
    {
        LNeutralDisplay display = TNeutral.TNeutralDisplayResolve(true, 210, 180, 170);
    ...
    {
        LNeutralDisplay display = TNeutral.TNeutralDisplayResolve(true, 0, 0, 0);
    ...
    {
        LNeutralDisplay display = TNeutral.TNeutralDisplayResolve(false, 210, 180, 170);
    ...
    public void Display_ManualRoundTripFromAutomatic_RestoresRememberedSample()
    {
        ...
        LNeutralDisplay automatic = TNeutral.TNeutralDisplayResolve(false, red, green, blue);
        LNeutralDisplay manual = TNeutral.TNeutralDisplayResolve(true, red, green, blue);
    ...
    {
        LNeutralDisplay display = TNeutral.TNeutralDisplayResolve(true, red, green, blue);
