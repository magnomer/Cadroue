...
public sealed class THistogramCount
{
    [Fact]
    public void Histogram_CountsPerChannelAndLuminance()
    {
        ...
        LHistogramCounts counts = THistogram.THistogramCreate(pixels, 2, 1);
    ...
    {
        LHistogramCounts counts = THistogram.THistogramCreate(System.Array.Empty<byte>(), 0, 0);
