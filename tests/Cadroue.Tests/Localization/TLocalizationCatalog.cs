...
public sealed class TLocalizationCatalog
{
    [Fact]
    ...
    {
        string lRepositoryPath = TLocalizationPathRead();
        ...
        foreach (string lGammaKey in TLocalizationGammaKeys)
        {
            Assert.Contains(lGammaKey, lLocalizationKeys);
        }
        foreach (string lWhitebalanceKey in TLocalizationWhitebalanceKeys)
        {
            Assert.Contains(lWhitebalanceKey, lLocalizationKeys);
        }
    }

    private static readonly string[] TLocalizationGammaKeys =
    {
        "Terms.Gamma",
    ...
    private static readonly string[] TLocalizationWhitebalanceKeys =
    {
        "Terms.Whitebalance",
    ...
    private static string TLocalizationPathRead()
    {
